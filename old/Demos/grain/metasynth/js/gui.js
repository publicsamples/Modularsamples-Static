function guiinit(){
	...
	$('#sample2').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/2.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample3').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/2softbeat120.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample4').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/3.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample5').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/75a.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample6').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/125C.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample7').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/basher120.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample8').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/Bt80.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample9').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/clangerdebate.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample10').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/Fall75.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample11').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/grace.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample12').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/grace2.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample13').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/inspace.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample14').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/Lambs90.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample15').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/m90d.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample16').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/modloop110low.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample17').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/moonpad.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample18').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/mountup.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample19').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/MuhTuning.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample20').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/multibass120.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample21').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/nicely120.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample22').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/py75.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample23').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/softpad.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample24').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/Spiffy.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample25').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/swan130.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample26').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/sweet115.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample27').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/t90a.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample28').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/techblur130.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample29').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/tinkle1.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample30').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/Troublement60.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample31').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/UmbongoAcid.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample32').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/up&up.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample33').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/zxdrone.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
