function guiinit(){
	...
	$('#sample1').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/AIR.mp3',true);
	...
	$('#sample2').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/all.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample3').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/bang.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample4').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/chim.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample5').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/deptthief.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample6').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/drumkite.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample7').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/efx.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample8').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/fluff.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample9').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/kite.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample10').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/listen.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample11').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/mello.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample12').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/MIGHT.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
	...
	$('#sample13').click(function(){
		...
		var request = new XMLHttpRequest();
			request.open('GET','audio/shiv3.mp3',true);
			request.responseType = "arraybuffer";
			request.onload = function(){
				context.decodeAudioData(request.response,function(b){
					buffer = b; //set the buffer
